...
async function seedUser () {
  try {
    ...
    userToBeInserted = await dbService.findOne(model.user,{ 'username':'Brittany.Rutherford9' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'aVUgALWySwT7SJn',
        'isDeleted':false,
        'username':'Brittany.Rutherford9',
        'email':'Tyrel_Okuneva@hotmail.com',
        'isActive':true,
      ...
      await dbService.update(model.user, { 'username':'Brittany.Rutherford9' }, userToBeInserted);
    }
    userToBeInserted = await dbService.findOne(model.user,{ 'username':'Palma_Davis79' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'VVF_4S5Y8yd2fQ8',
        'isDeleted':false,
        'username':'Palma_Davis79',
        'email':'Abigale_Gislason51@gmail.com',
        'isActive':true,
      ...
      userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
      await dbService.update(model.user, { 'username':'Palma_Davis79' }, userToBeInserted);
    }
